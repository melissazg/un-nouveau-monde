 ...
 */
class getSearchMusiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SearchMusiqueRepository' shared autowired service.
     *
     * @return \App\Repository\SearchMusiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SearchMusiqueRepository.php';

        return $container->privates['App\\Repository\\SearchMusiqueRepository'] = new \App\Repository\SearchMusiqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
