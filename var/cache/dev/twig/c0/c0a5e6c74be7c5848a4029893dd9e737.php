...
class __TwigTemplate_31eb9b1d1a2f4d3f7203fb3fce20db40 extends Template
{
    ...
    ";
        // line 11
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 11, $this->source); })()), "genre", [], "any", false, false, false, 11), 'row');
        echo "
    ...
    ";
        // line 15
        if ( !twig_test_empty((isset($context["films"]) || array_key_exists("films", $context) ? $context["films"] : (function () { throw new RuntimeError('Variable "films" does not exist.', 15, $this->source); })()))) {
            // line 16
        ...
        <ul>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["film"]) {
                ...
                echo " - ";
                echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["film"], "date", [], "any", false, false, false, 19), "d/m/Y"), "html", null, true);
                echo " - ";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["film"], "genre", [], "any", false, false, false, 19), "html", null, true);
                echo "</li>
            ";
            }
    ...
    {
        return array (  137 => 21,  124 => 19,  120 => 18,  116 => 16,  114 => 15,  109 => 13,  104 => 11,  100 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Filtrer les films{% endblock %}
...
{% block body %}
    ...
    {% if films is not empty %}
        ...
        <ul>
            {% for film in films %}
                <li>{{ film.name }} - {{ film.date|date('d/m/Y') }} - {{ film.genre }}</li>
            {% endfor %}
        </ul>
    {% endif %}
{% endblock %}
