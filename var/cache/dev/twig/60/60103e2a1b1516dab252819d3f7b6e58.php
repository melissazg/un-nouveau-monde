...
<div class=\"example-wrapper\">
    ...
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["film"]) {
            ...
            echo "\" alt=\"\" style=\"height: 50%;\"><div class=\"card-body\" style=\"height:50%;\">
                    <h5 class=\"card-title\" style=\"height:30%; font-weight: bold;font-size: 25px;text-align: center;\">";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["film"], "name", [], "any", false, false, false, 34));
            echo "</h5>
...
";
    ...
    {
        return array (  147 => 40,  135 => 34,  131 => 33,  128 => 32,  124 => 31,  110 => 20,  105 => 18,  100 => 16,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <ul>
        <div style=\"display: flex;flex-wrap: nowrap;\">
            ...
            <div class=\"card\" style=\"width: 20rem; height: 25rem; margin: 20px 20px; color:white; background-color: #441b71\">
                <img class=\"card-img-top\" src=\"{{ film.imagePath|e }}\" alt=\"\" style=\"height: 50%;\"><div class=\"card-body\" style=\"height:50%;\">
...
{% endblock %}", "catalogue/index.html.twig", "C:\\Users\\ULTRABOOK DELL\\OneDrive - UPEC\\Bureau\\Snowaddict-symfony\\Un_Nouveau_Monde\\templates\\catalogue\\index.html.twig");
    }
}
