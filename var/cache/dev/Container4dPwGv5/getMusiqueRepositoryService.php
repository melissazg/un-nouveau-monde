 ...
 */
class getMusiqueRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MusiqueRepository' shared autowired service.
     *
     * @return \App\Repository\MusiqueRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MusiqueRepository.php';

        return $container->privates['App\\Repository\\MusiqueRepository'] = new \App\Repository\MusiqueRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
