...
/* user/edit.html.twig */
class __TwigTemplate_16e3466f7a6383504a5c226c25faad60 extends Template
{
    private $source;
    private $macros = [];
                ...
                <div class=\"col-18 col-md-15 col-lg-10 col-xl-10\">
                    <div class=\"card bg-dark text-white\" style=\"border-radius: 1rem;\">
                        <div class=\"card-body p-8 text-center\">
                            <h1 class=\"mt-4\">Formulaire de modification</h1>
...
{% block body %}
    ...
    {{ form_end(form) }}
{% endblock %}
", "user/edit.html.twig", "/Applications/MAMP/htdocs/un-nouveau-monde/templates/user/edit.html.twig");
    }
}
