...
/* user/edit.html.twig */
class __TwigTemplate_237cd95bf8c5db0a2cd6ad037f5480d9 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo " UnNouveauMonde-Modification de l'utilisateur ";
                ...
                <div class=\"col-18 col-md-15 col-lg-10 col-xl-10\">
                    <div class=\"card bg-dark text-white\" style=\"border-radius: 1rem;\">
                        <div class=\"card-body p-8 text-center\">
                            <h1 class=\"mt-4\">Modification du profil</h1>
...
{% block title %} UnNouveauMonde-Modification de l'utilisateur {% endblock %}
...
{% block body %}
    ...
    {{ form_end(form) }}
{% endblock %}
", "user/edit.html.twig", "C:\\Users\\ULTRABOOK DELL\\OneDrive - UPEC\\Bureau\\Snowaddict-symfony\\Un_Nouveau_Monde\\templates\\user\\edit.html.twig");
    }
}
